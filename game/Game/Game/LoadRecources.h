...
bool LoadTextures(Textures & textures)
{
	return LoadTowerTextures(textures.tower1, textures.tower2, textures.tower3) &&
		...
		LoadPlayerTextures(textures.player) && LoadPortalTexture(textures.portal) &&
		LoadPortalTexture(textures.portal) && LoadCoinTexture(textures.coin) &&
		LoadMapTexture(textures.map) && LoadBonusesTextures(textures.bonuses) &&
		LoadBonusesTextures(textures.bonuses) && LoadBulletsTexture(textures.bullets) &&
		LoadMeteorTextures(textures.meteor) && LoadExplosionTexture(textures.explosion) &&
		LoadVignetteTexture(textures.vignette) && LoadToxicCloudTexture(textures.toxicCloud) &&
