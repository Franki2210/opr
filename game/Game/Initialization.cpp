...
void InitObstacles(Obstacles & obstacles)
{
	...
	obstacles.topObstacle.setSize(Vector2f(2050, 74));
	obstacles.downObstacle.setPosition(0, 1994);
	obstacles.downObstacle.setSize(Vector2f(2050, 74));
...
void InitBonuses(UsedBonuses & bonuses, Textures & textures)
{
	...
	bonuses.healthIncrease.SetBonus("healthInc", textures.bonuses.healthIncTex, 20, 8000, 0);
	...
	UsedTexts & usedTexts, Font & font)
{
	...
	InitCoin(usedEntities.coin, textures, font);
